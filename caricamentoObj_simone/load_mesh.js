...
/*========== Loading and storing the geometry ==========*/
   function LoadMesh(gl, obj) {
      ...
      //Ora che ho la obj.mesh e il/i materiali associati, mi occupo di caricare 
      ...
      map.set("map_Ka", loadTexture(gl, path, map.get("map_Ka")));
      map.set("map_bump", loadTexture(gl, path, map.get("map_bump")));
    ...
    if (obj.mesh.fileMTL == null){
      ...
      obj.ambient=obj.mesh.materials[1].parameter.get("Ka");
      obj.diffuse=obj.mesh.materials[1].parameter.get("Kd");
      obj.specular=obj.mesh.materials[1].parameter.get("Ks");
      obj.emissive=obj.mesh.materials[1].parameter.get("Ke");
      obj.shininess=obj.mesh.materials[1].parameter.get("Ns");
      obj.opacity=obj.mesh.materials[1].parameter.get("Ni");
    }
