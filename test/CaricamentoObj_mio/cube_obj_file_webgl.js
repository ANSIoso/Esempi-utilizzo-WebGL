...
imageGatto.src = "../models/cat/Cat_diffuse.jpg";
const imageRuota = new Image();
imageRuota.src = "../models/ruota/ruota_diffuse_giulio.png";
...
function main() {
  ...
  myLoadModel('../models/cat/12221_Cat_v1_l3.obj');
  myLoadModel('../models/ruota/ruota_davanti_gomma.obj');
  ...
  function drawScene(time) {
    ...
    // =======================
    var matrix = m4.translate(m4.identity(), 1, 0, -5)
