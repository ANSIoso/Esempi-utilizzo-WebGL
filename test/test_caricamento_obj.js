...
slider_bias = document.getElementById("bias");
...
slider_bias.addEventListener("input", function () {
	settings.bias = slider_bias.value;
});
...
async function main() {
	...
	console.log(meshProgramInfo.program);
	...
	function drawScene(projectionMatrix, cameraMatrix, textureMatrix, lightWorldMatrix, programInfo) {
		...
		u_world = m4.scale(m4.identity(), 6, 4, 6);
